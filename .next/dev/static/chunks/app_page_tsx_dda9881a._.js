    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
                ...
                window.scrollTo(0, 0);
                const reset = {
                    "Home.useEffect.reset": ()=>window.scrollTo(0, 0)
                }["Home.useEffect.reset"];
                window.addEventListener("beforeunload", reset);
                return ({
                    "Home.useEffect": ()=>window.removeEventListener("beforeunload", reset)
                })["Home.useEffect"];
            }
        }
    }["Home.useEffect"], []);
...
_s(Home, "Me2m+2sg/Ba3JF8trEmfRnbnnec=");
_c = Home;
var _c;
